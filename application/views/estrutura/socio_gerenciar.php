    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Gerenciamento de S&oacute;cios
                </h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">S&oacute;cio</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box-wrapper-btn">
                            <button class="btn btn-success" id="btn_redirect_cad_soc">Cadastrar S&oacute;cio</button>
                        </div>
                        ...
                        <div class="box box-wrapper-50">
                            ...
                            <div class="box-body">
                                ...
                                <table id="tbl_estrutura" class="display" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>S&oacute;cio</th>
    ...
    <script>
        $(document).ready(function () {
            $('#tbl_estrutura').DataTable({
                ...
                "ajax": {
                    url: '<?=base_url('./admin/estrutura/buscarSocio')?>',
                    type: 'POST'
                },
                "language": {
