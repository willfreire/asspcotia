    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Gerenciamento de Conselho Fiscal
                </h1>
                <ol class="breadcrumb">
                    <li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box-wrapper-btn">
                            <button class="btn btn-success" id="btn_redirect_cad_cons">Cadastrar Conselheiro</button>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('#tbl_estrutura').DataTable({
                ...
                "ajax": {
                    url: '<?=base_url('./admin/estrutura/buscarConselho')?>',
                    type: 'POST'
                },
                "language": {
