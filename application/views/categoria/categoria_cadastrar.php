                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="container-fluid box box-primary" id="box-frm-categoria">
                            ...
                            <form role="form" name="frm_cad_categoria" id="frm_cad_categoria">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="categoria" name="categoria" placeholder="Categoria" maxlength="50" required="true">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <button type="submit" id="btn_cad_categoria" name="btn_cad_categoria" class="btn btn-success">Cadastrar</button>
