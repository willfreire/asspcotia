        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-calendar" aria-hidden="true"></i> Agendas</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box-wrapper-btn">
                            <button class="btn btn-success" id="btn_redirect_cad">Cadastrar Agenda</button>
                        </div>
                        ...
                        <div class="box box-wrapper-80">
                            ...
                            <div class="box-body">
                                ...
                                <table id="tbl_agenda" class="display" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Data</th>
    ...
    <script>
        $(document).ready(function () {
            $('#tbl_agenda').DataTable({
                ...
                "ajax": {
                    url: '<?=base_url('./admin/agenda/buscarAgenda')?>',
                    type: 'POST'
                },
                "language": {
